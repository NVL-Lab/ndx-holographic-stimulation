...
# Next Steps for ndx-holostim Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-holostim directory: `cd ndx-holostim`
...
`spec/ndx-holostim.namespace.yaml` and
`spec/ndx-holostim.extensions.yaml` files.

6. Define API classes for your new extension data types.

    - As a starting point, `src/pynwb/ndx_holostim/__init__.py` includes an
...
`src/pynwb/ndx_holostim/tests` or `src/matnwb/tests`.
...
`src/pynwb/ndx_holostim/widgets` so that the visualizations can be displayed with
[nwbwidgets](https://github.com/NeurodataWithoutBorders/nwbwidgets).
You will also need to update the `vis_spec` dictionary in 
`src/pynwb/ndx_holostim/widgets/__init__.py` so that
...
2. Start a git repository for your extension directory ndx-holostim
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/AndreaDieffe/ndx-holostim/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-holostim/0.1.0
...
`staged-extensions/ndx-holostim`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-holostim
    ```

13. Edit `staged-extensions/ndx-holostim/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      name: ndx-holostim
      version: 0.1.0
      src: https://github.com/AndreaDieffe/ndx-holostim
      pip: https://pypi.org/project/ndx-holostim/
      license: BSD-3-Clause
      maintainers: 
        - AndreaDieffe
      ```

14. Edit `staged-extensions/ndx-holostim/README.md`
to add information about your extension. You may copy it from
`ndx-holostim/README.md`.

  ```bash
  cp ndx-holostim/README.md staged-extensions/ndx-holostim/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-holostim
git commit -m "Add new catalog entry for ndx-holostim" .
git push
```
...
ndx-holostim-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-holostim GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-holostim-record repository on GitHub.
